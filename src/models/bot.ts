...
import { AccountsChannelService, DonateChannelService, JobService, Logger } from '../services/index.js';
...
export class Bot {
    ...
    constructor(
        ...
        private donateChannelService?: DonateChannelService
    ) {}
    ...
    private async onReady(): Promise<void> {
        ...
        await this.accountsChannelService?.initChannel().catch(() => null);
        await this.donateChannelService?.initChannel().catch(() => null);
    }
